...
(function($){	
	var _jQuizMeLayout = $("<div/>").addClass( "quiz-el").append( 
		...
		$("<div/>").addClass( "q-help q-innerArea").append( 
			$("<div/>").addClass( "q-help-menu" ).append(
				$( "<span/>" ).addClass( "q-quit-area" ).append(
					$( "<input type ='button'/>" ).addClass( "q-quit-btn btn btn-default" ),
					$( "<input type='button'/>" ).addClass( "q-quitYes-btn q-quit-confirm btn btn-default" ).hide(),
					$( "<input type='button'/>" ).addClass( "q-quitNo-btn q-quit-confirm btn btn-default" ).hide()
				),
				$("<input type='button'/>").addClass( "q-help-btn btn btn-default" ),									
				$( "<span/>" ).addClass( "q-timer-area" ),
				$("<div/>").addClass( "q-help-info" ).hide()
			)
		),
		$("<div/>").addClass( "q-review-menu q-innerArea").append( 
			$("<input type='button'/>").addClass( "q-details-btn btn-block btn btn-default" ),
			$("<input type='button'/>").addClass( "q-review-btn btn-block btn btn-default" ),
		...
		$("<div/>").addClass( "q-intro q-innerArea" ).append(
			...
			$( '<input type="button"/>' ).addClass( "q-begin-btn btn btn-default" )
		).hide(),
		$("<div/>").addClass( "q-prob q-innerArea" ).append( 
			...
			$("<div/>").addClass( "q-ans q-probArea").append(
					...
					$( "<div/>" ).addClass( "q-btns" ).append(
						$( "<input type='button'/>" ).addClass( "q-check-btn btn btn-primary" ),
						$( "<input type='button'/>" ).addClass( "q-next-btn btn btn-primary" )
					)
				),
		...
		$("<div/>").addClass( "q-gameOver q-innerArea" ).append(
			...
			$("<div/>").addClass( "q-options q-probArea q-center").append( 
				$("<input type='button'/>").addClass( "q-restart-btn btn btn-primary" ),
				$("<input type='button'/>").addClass( "q-del-btn btn btn-primary" ) 
			)
		).hide()
	);
